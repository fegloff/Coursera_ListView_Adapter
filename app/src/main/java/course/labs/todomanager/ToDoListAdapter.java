...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.statusCheckBox.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					@Override
        ...
        Log.i(TAG,"EPA EPA EPA " + toDoItem.getPriority());
        switch (toDoItem.getPriority()) {
            case HIGH:
                holder.priorityView.setText(R.string.priority_high_string);
                break;
            case LOW:
                holder.priorityView.setText(R.string.priority_low_string);
                break;
            case MED:
                holder.priorityView.setText(R.string.priority_medium_string);
                break;
        }
